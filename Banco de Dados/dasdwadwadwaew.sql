...
CONSTRAINT chkEmail1
    ...
    CONSTRAINT chkEmail10
	CHECK (emailFucionarioProfissional like '%@%.com'),
 cep CHAR(8),
...
INSERT INTO funcionario (idFuncionario, fkTransportadora, nomeFuncionario, cargoFuncionario, cpfFuncionario, emailFucionarioPessoal, emailFucionarioProfissional, telefoneFuncionario, cep, senhaAcesso)
VALUES 
(1, 1, 'Carlos Silva', 'Representante', '12345678901', 'carlos@exemplo.com', 'carlos@transmed.com', '11-98765-4321', '01001000', 'senha123'),
(2, 1, 'Ana Pereira', 'Motorista', '98765432100', 'ana@exemplo.com', 'ana@transmed.com', '11-91234-5678', '02002000', 'senha456'),
(3, 2, 'João Oliveira', 'Representante', '45678912300', 'joao@exemplo.com', 'joao@logsaude.com', '21-99876-5432', '03003000', 'senha789'),
(4, 2, 'Luiza Silva', 'Motorista', '98765432100', 'luizasilva@exemplo.com', 'luiza@logsaude.com', '11-95554-5558', '06006000', 'senha999');
